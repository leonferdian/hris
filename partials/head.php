<head>
	...
	<meta charset="utf-8" />
	<link rel="icon" type="image/gif/png" href="images/apple-touch-icon.png">
	...
	<!-- ace styles -->
	<link rel="stylesheet" href="assets/css/ace.min.css?version=13" class="ace-main-stylesheet" id="main-ace-style" />
	...
	<!-- datatables fixed header styles -->
	<link rel="stylesheet" href="styles/fixedHeader.dataTables.min.css" />
	<link rel="stylesheet" href="styles/dataTables.bootstrap.min.css" />
	<link rel="stylesheet" href="styles/fixedHeader.bootstrap.min.css" />
	<!-- Ladda -->
	...
	<script src="js/fixed_column/jquery.CongelarFilaColumna.js"></script>
	...
	<!-- ===================FIX COLUMN===============================-->
	<script type="text/javascript" src="js/fixed_column/tableHeadFixer.js"></script>
	...
	<script type="text/javascript" src="js/currency/accounting.min.js"></script>
	<!-- Barcode Jquery -->
	...
	<script src="assets/ladda/dist/ladda.jquery.min.js"></script>
