        ...
        ?>
            <tr class="odd gradeX">
                ...
                <td style="vertical-align:middle; text-align:center;">
                    ...
                    <a href="?sm=pengajuan_karyawan&act=edit_dialog&id=<?php echo $row['id']; ?>" class="btn btn-xs btn-info" >
                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                    </a>
                    <a href="#" class="btn btn-xs btn-danger" onclick="del('<?php echo $row['id']; ?>')">
