<script>
	$(document).ready(function () {
		...
		*/
		...
		$('#editor3').css({ 'height': '200px' }).ace_wysiwyg({
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="kategori_karyawan" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="nama_outsourcing" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="lama_kerja_th" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="lama_kerja_bln" placeholder="" <?php echo  "readonly"; ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="status_pkwt" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm datepicker"
																id="tgl_akhir_pkwt" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="nama_grade" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="sub_grade" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="grade_level" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="skema_insentif" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="potongan_bpjs_tk" placeholder="" <?php echo  "readonly"; ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="potongan_bpjs_kes" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="kode_finger" placeholder="" <?php echo  "readonly"; ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="tempat_lahir" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm datepicker"
																id="tgl_lahir" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="j_pengenal" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="no_pengenal" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="no_kk" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="alamat_ktp" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="kota" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="alamat_domisili" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="kota_domisili" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="telepon" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="handphone" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['handphone'] : ""; ?>">
														</div>
													</div>
												</form>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="email" class="form-control input-sm"
																id="email" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="agama" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="pendidikan" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="institusi" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm datepicker"
																id="tgl_awal_kerja" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm datepicker"
																id="tgl_akhir_kerja" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="status" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="bank" placeholder="" <?php echo  "readonly"; ?>
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="no_rekening" placeholder="" <?php echo  "readonly"; ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm input-mask-npwp"
																id="no_npwp" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="no_bpjs_kes" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="no_bpjs_tk" placeholder="" <?php echo  "readonly"; ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="nama_pasangan" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="telp_pasangan" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm datepicker"
																id="tgl_lahir_pasangan" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="nama_kerja_pasangan" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="lokasi_kerja_pasangan" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="nama_anak1" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm datepicker"
																id="tgl_lahir_anak1" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="nama_anak2" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm datepicker"
																id="tgl_lahir_anak2" placeholder="" <?php echo  "readonly"; ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="nama_anak3" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm datepicker"
																id="tgl_lahir_anak3" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="nama_jaminan" placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm"
																id="no_jaminan" placeholder="" <?php echo  "readonly"; ?>
		...
		<div class="col-md-12">
			<div class="pull-right <?php echo  $_GET['act'] == "detail_karyawan" ? "hide" : ""; ?>" style="">
				...
				<div id="ProgressDialog" style="display:none">
					...
					<button type="button" class="btn btn-sm btn-danger" onclick="save_karyawan('reject')">
						<i class="ace-icon fa fa-times align-top bigger-125"></i> Reject
					</button>
					<button type="button" class="btn btn-sm btn-success" onclick="save_karyawan('proses')">
						<i class="ace-icon fa fa-check align-top bigger-125"></i> Approve
					</button>
				</div>
			</div>
		</div>
...
<script>
    ...
    function save_karyawan(status_data) {
		...
		var alasan_reject = $("#editor3").html();
		var foto_profile = "YA";
		var foto_ktp = "YA";
		var foto_sim = "YA";
		...
		if (pin == "" || nik  == "" || kategori_karyawan  == "" || nama  == "" || lama_kerja_th  == "" || lama_kerja_bln  == "" || status_pkwt  == "" || nama_grade  == "" || sub_grade  == "" || tahun  == "" || grade_level  == "" || skema_insentif  == "" || thp  == "" || potongan_bpjs_tk  == "" || potongan_bpjs_kes  == "" || kode_finger  == "" || tempat_lahir  == "" || tgl_lahir  == "" || j_pengenal  == "" || no_pengenal  == "" || no_kk  == "" || alamat_ktp  == "" || kota  == "" || alamat_domisili  == "" || kota_domisili  == "" || telepon  == "" || handphone  == "" || email  == "" || agama  == "" || pendidikan  == "" || institusi  == "" || tgl_awal_kerja  == "" || status  == "" || bank  == "" || no_rekening  == "" || no_npwp  == "" || no_bpjs_kes  == "" || no_bpjs_tk  == "" || nama_pasangan  == "" || telp_pasangan  == "" || nama_kerja_pasangan  == "" || lokasi_kerja_pasangan  == "" || nama_anak1  == "" || nama_anak2  == "" || nama_anak3  == "" || nama_jaminan == "" || no_jaminan == "") {
			...
			$.ajax({
				type: "POST",
				url: "inc/karyawan/data_karyawan_approval/proc_karyawan.php",
				traditional: true,
				data: {
					act: "save_karyawan",
					nama_pt : nama_pt,
				...
				success: function(data) {
					if (data.trim() == 'Data Saved') {
						...
						location.href="?sm=data_karyawan_approval";
						setTimeout(function() {
							$.gritter.removeAll();
						}, 5000);
					}
