<?php if (isset($_GET['act']) && $_GET['act'] == "add_dialog"):  ?>
    <?php include 'inc/karyawan/tes_soal/form_data.php'; ?>
...
<div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Soal Tes Calon Karywan</li>
        </ul>
    </div>
    <div class="page-content">
        <div class="page-header">
            <div class="pull-right">
                <a href="?sm=tes_soal&act=add_dialog" class="btn btn-xs btn-white btn-primary">
                    <i class="fa fa-plus"></i> Create Soal
                </a>
            </div>
            <h1>
                Soal Tes Calon Karywan
            </h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
...
<script>
    ...
    function view_report() {
        ...
        $.ajax({
            type: "GET",
            url: "inc/karyawan/tes_soal/view_report.php",
            traditional: true,
            // data: },
