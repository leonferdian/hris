...
if(isset($_GET['detail_page']) && $_GET['detail_page'] == "form_karyawan"):
	include "inc/karyawan/data_karyawan_draft/form_karyawan.php";
else:
?>
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Pengubahan Data Karyawan</li>
            </ul>
        </div>
        <div class="page-content">
            <div class="page-header">
                <div class="pull-right hide">
                    <a class="btn btn-xs btn-success" href="?sm=data_karyawan_draft&detail_page=form_karyawan&act=add_karyawan" title="Create Karyawan">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-white btn-warning" href="?sm=data_karyawan_draft&detail_page=form_karyawan&act=detail_karyawan&id=<?php echo $row['id'];?>">
                                                <?php echo $row['nik'];?>
                                            </a>
                                        </td>
                                        ...
                                        <td class="center">
                                            <div class="btn-group">
                                                <a class="btn btn-xs btn-white btn-info" href="?sm=data_karyawan_draft&detail_page=form_karyawan&act=edit_karyawan&nik=<?php echo $row['nik'];?>">
                                                    Edit Data
                                                </a>
                                            </div>
                                        </td>
