<?php if (isset($_GET['act']) && $_GET['act'] == "add"):  ?>
    <?php include 'inc/karyawan/rekap_kandidat/form.php'; ?>
...
<div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Rekap Kandidat</li>
        </ul>
    </div>
            ...
            <div class="col-sm-12">
                <div class="table-header">
					<div class="pull-right">
						<!-- <a class="btn btn-white btn-xs btn-success" href="?sm=rekap_kandidat&act=add"><i class="fa fa-plus"></i> Create New</a> -->
						&nbsp;
					</div>
                    <br>
				</div>
...
<script>
    ...
    function view() {
        ...
        $.ajax({
            type: "GET",
            url: "inc/karyawan/rekap_kandidat/view_report.php",
            traditional: true,
            data: {
                tgl1: tgl1,
                tgl2: tgl2,
