<script>
	$(document).ready(function () {
		...
		*/
		...
		$('#editor4').css({ 'height': '200px' }).ace_wysiwyg({
	...
	<div class="page-content">
		<div class="page-header">
			<div class="pull-left" style="display:none;">
				<button type="button" class="btn btn-primary" onclick="save_customer('<?php echo $_SESSION['id_user']; ?>')">
										...
										<div class="widget-body">
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal"></form>
													<div class="form-group">
														<label class="col-sm-5">Foto KTP</label>
														<span class="foto-ktp">
															<?php if ($_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan"): ?>
																<?php if ($row['foto_ktp'] != ""): ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal"></form>
													<div class="form-group">
														<label class="col-sm-5">Foto SIM</label>
														<span class="foto-sim">
															<?php if ($_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan"): ?>
																<?php if ($row['foto_sim'] != ""): ?>
										...
										<div class="widget-body">
												...
												<form class="form-horizontal">
													<div class="form-group">
														<label class="col-sm-5">
															<input id="check-all" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Check All</span>
														</label>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama_pt" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Nama PT</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
																name="nama_pt" id="nama_pt"
																data-placeholder="Choose a State..." onchange="" <?php echo  "disabled"; ?>>
																<?php
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="entity" class="ace ace-checkbox-2" type="checkbox">
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="depo" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Depo</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
																name="depo" id="depo"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama" class="ace ace-checkbox-2" type="checkbox">
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="pin" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Pin</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm" name="pin"
																placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nik" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> NIK</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm" name="nik"
																placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="kategori_karyawan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Kategori Karyawan</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="kategori_karyawan" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['kategori_karyawan'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama_outsourcing" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Nama Outsourcing</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="nama_outsourcing" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['nama_outsourcing'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="lama_kerja_th" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Lama Tahun Kerja</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="lama_kerja_th" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['lama_kerja_th'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="lama_kerja_bln" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Lama Bulan Kerja</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="lama_kerja_bln" placeholder="" <?php echo  "readonly"; ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="status_pkwt" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Status PKWT</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="status_pkwt" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['status_pkwt'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="status_kontrak_kerja" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Status Kontrak kerja</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tgl_akhir_pkwt" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tgl Akhir PKWT</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm datepicker"
																name="tgl_akhir_pkwt" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo isset($row['tgl_akhir_pkwt']) && $row['tgl_akhir_pkwt'] != "" ? date_format($row['tgl_akhir_pkwt'], "d/m/Y") : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama_grade" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Nama Grade</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="nama_grade" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['nama_grade'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="sub_grade" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Subgrade</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="sub_grade" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['sub_grade'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tahun" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tahun</span>
														</label>
														<div class="col-sm-7">
															<input type="text"
																class="form-control input-sm input-mask-tahun"
																name="tahun" placeholder="1999"
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['tahun'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="grade_level" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Grade Level</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="grade_level" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['grade_level'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="skema_insentif" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Skema Insentif</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="skema_insentif" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['skema_insentif'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="THP" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> THP</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm" name="THP"
																placeholder="" <?php echo  "readonly"; ?>
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="potongan_bpjs_tk" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Potongan BPJSTK</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="potongan_bpjs_tk" placeholder="" <?php echo  "readonly"; ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="potongan_bpjs_kes" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Potongan BPJSKES</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="potongan_bpjs_kes" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['potongan_bpjs_kes'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="bagian" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Bagian</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="sub_bagian" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Sub Bagian</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="seksi" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Seksi</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
																name="seksi" id="seksi"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="jabatan" class="ace ace-checkbox-2" type="checkbox">
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="divisi" class="ace ace-checkbox-2" type="checkbox">
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="brand" class="ace ace-checkbox-2" type="checkbox">
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="active" class="ace ace-checkbox-2" type="checkbox">
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="kode_finger" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Kode Finger</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="kode_finger" placeholder="" <?php echo  "readonly"; ?>
										...
										<div class="widget-body">
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tempat_lahir" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tempat Lahir</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="tempat_lahir" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['tempat_lahir'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tgl_lahir" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tanggal Lahir</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm datepicker"
																name="tgl_lahir" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo isset($row['tgl_lahir']) && $row['tgl_lahir'] != "" ? date_format($row['tgl_lahir'], "d/m/Y") : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="j_pengenal" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Jenis Pengenal</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="j_pengenal" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['j_pengenal'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="no_pengenal" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> No Pengenal</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="no_pengenal" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['no_pengenal'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="no_kk" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> No KK</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="no_kk" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['no_kk'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="alamat_ktp" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Alamat KTP</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="alamat_ktp" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['alamat_ktp'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="kota" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Kota</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="kota" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['kota'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="alamat_domisili" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Alamat Domisili</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="alamat_domisili" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['alamat_domisili'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="kota_domisili" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Kota Domisili</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="kota_domisili" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['kota_domisili'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="telepon" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Telepon</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="telepon" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['handphone'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="handphone" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Handphone</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="handphone" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['handphone'] : ""; ?>">
														</div>
													</div>
												</form>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="email" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Email</span>
														</label>
														<div class="col-sm-7">
															<input type="email" class="form-control input-sm"
																name="email" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['email'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="agama" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Agama</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="agama" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['agama'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="pendidikan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Pendidikan</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="pendidikan" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['pendidikan'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="institusi" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Institusi</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="institusi" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['institusi'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tgl_awal_kerja" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tanggal Awal Kerja</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm datepicker"
																name="tgl_awal_kerja" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo isset($row['tgl_awal_kerja']) && $row['tgl_awal_kerja'] != "" ? date_format($row['tgl_awal_kerja'], "d/m/Y") : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tgl_akhir_kerja" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tanggal Akhir Kerja</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm datepicker"
																name="tgl_akhir_kerja" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo isset($row['tgl_akhir_kerja']) && $row['tgl_akhir_kerja'] != "" ? date_format($row['tgl_akhir_kerja'], "d/m/Y") : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="status" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Status</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="status" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['status'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="jenis_kelamin" class="ace ace-checkbox-2" type="checkbox">
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="bank" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Bank</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="bank" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['bank'] : ""; ?>">
														</div>
													</div><div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="no_rekening" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> No Rekening</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="no_rekening" placeholder="" <?php echo  "readonly"; ?>
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="status_pph_21" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Status PPH 21</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="no_npwp" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> No. NPWP</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm input-mask-npwp"
																name="no_npwp" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['no_npwp'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="no_bpjs_kes" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> No. BPJS Kes</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="no_bpjs_kes" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['no_bpjs_kes']  : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="no_bpjs_tk" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> No. BPJS TK</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="no_bpjs_tk" placeholder="" <?php echo  "readonly"; ?>
										...
										<div class="widget-body">
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama_pasangan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Nama Pasangan</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="nama_pasangan" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['nama_pasangan'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="telp_pasangan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Telp Pasangan</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="telp_pasangan" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['telp_pasangan'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tgl_lahir_pasangan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tanggal Lahir Pasangan</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm datepicker"
																name="tgl_lahir_pasangan" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo isset($row['tgl_lahir_pasangan']) && $row['tgl_lahir_pasangan'] != "" ? date_format($row['tgl_lahir_pasangan'], "d/m/Y") : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama_kerja_pasangan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Nama Kerja Pasangan</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="nama_kerja_pasangan" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['nama_kerja_pasangan'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="lokasi_kerja_pasangan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Lokasi Kerja Pasangan</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="lokasi_kerja_pasangan" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['lokasi_kerja_pasangan'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama_anak1" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> <b>Nama Anak 1</b></span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="nama_anak1" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['nama_anak1'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tgl_lahir_anak1" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tgl Lahir 1</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm datepicker"
																name="tgl_lahir_anak1" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo isset($row['tgl_lahir_anak1']) && $row['tgl_lahir_anak1'] != "" ? date_format($row['tgl_lahir_anak1'], "d/m/Y") : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="gender_anak1" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Gender anak 1</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama_anak2" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> <b>Nama Anak 2</b></span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="nama_anak2" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['nama_anak2'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tgl_lahir_anak2" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tgl Lahir 2</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm datepicker"
																name="tgl_lahir_anak2" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo isset($row['tgl_lahir_anak2']) && $row['tgl_lahir_anak2'] != "" ? date_format($row['tgl_lahir_anak2'], "d/m/Y") : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="gender_anak2" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Gender Anak 2</span>
														</label>
														<div class="col-sm-7">
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama_anak3" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> <b>Nama Anak 3</b></span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="nama_anak3" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['nama_anak3'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="tgl_lahir_anak3" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Tgl Lahir 3</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm datepicker"
																name="tgl_lahir_anak3" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo isset($row['tgl_lahir_anak3']) && $row['tgl_lahir_anak3'] != "" ? date_format($row['tgl_lahir_anak3'], "d/m/Y") : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="gender_anak3" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Gender Anak 3</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="wajib_jaminan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Wajib Jaminan</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="nama_jaminan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Nama Jaminan</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="nama_jaminan" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['nama_jaminan'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="no_jaminan" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> No. Jaminan</span>
														</label>
														<div class="col-sm-7">
															<input type="text" class="form-control input-sm"
																name="no_jaminan" placeholder="" <?php echo  "readonly"; ?>
																value="<?php echo $_GET['act'] == "edit_karyawan" || $_GET['act'] == "detail_karyawan" ? $row['no_jaminan'] : ""; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="terdaftar_bpjs_kes" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Terdaftar BPJS Kes</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<input name="save[]" value="terdaftar_bpjs_tk" class="ace ace-checkbox-2" type="checkbox">
															<span class="lbl"> Terdaftar BPJS TK</span>
														</label>
														<div class="col-sm-7">
															<select class="form-control input-sm chosen-select"
													...
													<div class="form-group">
														<label class="col-sm-5">
															<span class="lbl"> Note Update</span>
														</label>
														<div class="col-sm-7">
															<div class="widget-box widget-color-green">
											...
											<div class="col-md-4 widget_1_box2" style="">
												<form class="form-horizontal">
													<div class="form-group">
														<label class="col-sm-5">
															<span class="lbl"> Note Reject</span>
														</label>
														<div class="col-sm-7">
															<div class="widget-box widget-color-green">
																<div class="widget-header widget-header-small"> </div>
		...
		<div class="col-md-12">
			<div class="pull-right <?php echo  $_GET['act'] == "detail_karyawan" ? "hide" : ""; ?>" style="">
				...
				<div id="ProgressDialog" style="display:none">
					...
					<button type="button" id="RejectButton" class="btn btn-sm btn-danger">
						<i class="ace-icon fa fa-times align-top bigger-125"></i> Reject
					</button>
					<button type="button" id="VerifyButton" class="btn btn-sm btn-info">
						<i class="ace-icon fa fa-check-circle align-top bigger-125"></i> Verify
					</button>
				</div>
			</div>
		</div>
...
<script>
	$(document).ready(function(){
		...
		$('#check-all').click(function(){
			$('.ace-checkbox-2').prop('checked', this.checked);
		});
		...
		$('#RejectButton').click(function(e){
			...
			// Collect the selected input fields
			var selectedInputs = {};

			$('.ace-checkbox-2:checked').each(function(){
				var inputName = $(this).val();
				selectedInputs[inputName] = $('input[name="' + inputName + '"]').val();
			});

			// Check if no checkboxes are selected
			if ($.isEmptyObject(selectedInputs)) {
				alert('Please select at least one field to save.');
				$("#ProgressDialog").dialog("close");
				return; // Stop further execution
			}

			selectedInputs['act'] = 'save_karyawan';
			selectedInputs['status_data'] = 'reject';
			selectedInputs['alasan_reject_hrd'] = $('#editor4').html();

			// Send the selected inputs to the server via AJAX
			$.ajax({
				url: 'inc/karyawan/data_karyawan_hrd/proc_karyawan.php',
				type: 'POST',
				data: selectedInputs,
				success: function(response){
					if (response.trim() == 'Data Saved') {
						$.gritter.add({
						...
						location.href="?sm=data_karyawan_hrd";
						setTimeout(function() {
							$.gritter.removeAll();
						}, 5000);
					}
		...
		$('#VerifyButton').click(function(e){
			...
			selectedInputs['act'] = 'save_karyawan';
			selectedInputs['status_data'] = 'complete';
			selectedInputs['alasan_reject_hrd'] = $('#editor4').html();
    ...
    function save_karyawan(status_data) {
		...
		var alasan_reject_hrd = $("#editor4").html();
		var foto_profile = "YA";
		var foto_ktp = "YA";
		var foto_sim = "YA";
		...
		if (pin == "" || nik  == "" || kategori_karyawan  == "" || nama  == "" || lama_kerja_th  == "" || lama_kerja_bln  == "" || status_pkwt  == "" || nama_grade  == "" || sub_grade  == "" || tahun  == "" || grade_level  == "" || skema_insentif  == "" || thp  == "" || potongan_bpjs_tk  == "" || potongan_bpjs_kes  == "" || kode_finger  == "" || tempat_lahir  == "" || tgl_lahir  == "" || j_pengenal  == "" || no_pengenal  == "" || no_kk  == "" || alamat_ktp  == "" || kota  == "" || alamat_domisili  == "" || kota_domisili  == "" || telepon  == "" || handphone  == "" || email  == "" || agama  == "" || pendidikan  == "" || institusi  == "" || tgl_awal_kerja  == "" || status  == "" || bank  == "" || no_rekening  == "" || no_npwp  == "" || no_bpjs_kes  == "" || no_bpjs_tk  == "" || nama_pasangan  == "" || telp_pasangan  == "" || nama_kerja_pasangan  == "" || lokasi_kerja_pasangan  == "" || nama_anak1  == "" || nama_anak2  == "" || nama_anak3  == "" || nama_jaminan == "" || no_jaminan == "") {
			...
			$.ajax({
				...
				data: {
					...
					alasan_reject_hrd : alasan_reject_hrd,
