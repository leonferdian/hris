<?php if (isset($_GET['act']) && $_GET['act'] == "add_dialog"):  ?>
    <?php include 'inc/karyawan/form_penilaian/form_data.php'; ?>
    ...
    <div class="page-content">
        <div class="page-header">
            <div class="pull-right">
                <a href="?sm=form_penilaian&act=add_dialog" class="btn btn-xs btn-white btn-primary">
...
<script>
    ...
    function view_report() {
        ...
        $.ajax({
            type: "GET",
            url: "inc/karyawan/form_penilaian/view_report.php",
            traditional: true,
            data: {
                divisi: divisi,
                tahun: tahun,
