...
if(isset($_POST['act']) && $_POST['act']=="add_data"):
    $sql_add = "INSERT INTO [db_hris].[dbo].[table_master_bagian] 
    (
        [kode]
        ,[nama_bagian]
        ,[create_by]
    ...
    (
        ...
        ,'".validate_input($_POST['nama_bagian'])."'
        ,'".$_SESSION['nama']."'
        ,getdate()
        ,'".$_SESSION['nama']."'
        ,getdate()
...
elseif (isset($_POST['act']) && $_POST['act']=="edit_data"):
    $sql_update = "UPDATE [db_hris].[dbo].[table_master_bagian] SET 
    kode = '".validate_input($_POST['kode'])."'
    ,nama_bagian = '".validate_input($_POST['nama_bagian'])."'
...
elseif(isset($_POST['act']) && $_POST['act']=="del"):
    $sql_del = "DELETE FROM [db_hris].[dbo].[table_master_bagian] WHERE id = '".validate_input($_POST['id'])."'";
...
elseif(isset($_POST['act']) && ($_POST['act']=="add_dialog" || $_POST['act']=="edit_dialog")):
    if($_POST['act']=="edit_dialog"):
        $sql_select = "select * from [db_hris].[dbo].[table_master_bagian] where id = '".$_POST['id']."'";
    ...
    <div class="row" style="width:100%;height:100%; margin-left: 5px;">
        ...
        <label class="col-sm-12 control-label">Nama Bagian</label> 
        <div class="col-sm-10">
            <input type="text" class="form-control input-sm" id="nama_bagian" name = "nama_bagian" value="<?php echo $_POST['act'] == "edit_dialog" ? trim($row_select['nama_bagian']) : ""; ?>" >
        </div>
    </div>
    <?php 
endif;
