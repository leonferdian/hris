...
<script>
    $(document).ready(function(){
        var table = $('#data_master_bagian').DataTable({
            // order: [[ 0, "asc" ]],
            "paging": true,
            "bSort": true,
            "lengthChange": true,
...
<table width="100%" class="table table-striped table-bordered table-hover" id="data_master_bagian">
    <thead>
        <tr>
    ...
    <tbody>
        <?php
        $sql = "select * from [db_hris].[dbo].[table_master_bagian]";
        $no = 1;
