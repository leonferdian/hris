<div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Master Leave Category</li>
        </ul>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h2 class="modal-title font-weight-bold">Leave Category</h2>
            </div>
...
<script>
    ...
    function view_report() {
        ...
        $.ajax({
            type: "GET",
            url: "inc/master/master_leave_category/view_report.php",
            traditional: true,
            // data: },
    ...
    function add_dialog() {
        ...
        $.ajax({
            type: "POST",
            url: "inc/master/master_leave_category/add_edit_delete.php",
            traditional: true,
            data:{
                act: 'add_dialog'
            },
    ...
    function add_lc() {
        var leave_category = $("#modal_add_master #leave_category").val();
        var keterangan = $("#modal_add_master #keterangan").val();
        if (leave_category == "" || keterangan == "") {
    ...
    function edit_lc() {
        ...
        var leave_category = $("#modal_edit_master #leave_category").val();
        var keterangan = $("#modal_edit_master #keterangan").val();
        if (leave_category == "" || keterangan == "") {
            alert("Semua data harus diisi");
        } else {
            $.ajax({
