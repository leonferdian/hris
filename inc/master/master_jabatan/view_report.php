...
<script>
    $(document).ready(function(){
        var table = $('#data_master_jabatan').DataTable({
            // order: [[ 0, "asc" ]],
            "paging": true,
            "bSort": true,
            "lengthChange": true,
...
<table width="100%" class="table table-striped table-bordered table-hover" id="data_master_jabatan">
    <thead>
        <tr>
    ...
    <tbody>
        <?php
        $sql = "select * from [db_hris].[dbo].[table_master_jabatan]";
        $no = 1;
