...
if(isset($_POST['act']) && $_POST['act']=="add_data"):
    $sql_add = "INSERT INTO [db_hris].[dbo].[table_master_jabatan] 
    (
        [kode]
        ,[nama_jabatan]
        ,[create_by]
    ...
    (
        ...
        ,'".validate_input($_POST['nama_jabatan'])."'
        ,'".$_SESSION['nama']."'
        ,getdate()
        ,'".$_SESSION['nama']."'
        ,getdate()
...
elseif (isset($_POST['act']) && $_POST['act']=="edit_data"):
    $sql_update = "UPDATE [db_hris].[dbo].[table_master_jabatan] SET 
    kode = '".validate_input($_POST['kode'])."'
    ,nama_jabatan = '".validate_input($_POST['nama_jabatan'])."'
...
elseif(isset($_POST['act']) && $_POST['act']=="del"):
    $sql_del = "DELETE FROM [db_hris].[dbo].[table_master_jabatan] WHERE id = '".validate_input($_POST['id'])."'";
...
elseif(isset($_POST['act']) && ($_POST['act']=="add_dialog" || $_POST['act']=="edit_dialog")):
    if($_POST['act']=="edit_dialog"):
        $sql_select = "select * from [db_hris].[dbo].[table_master_jabatan] where id = '".$_POST['id']."'";
    ...
    <div class="row" style="width:100%;height:100%; margin-left: 5px;">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control input-sm" id="nama_jabatan" name = "nama_jabatan" value="<?php echo $_POST['act'] == "edit_dialog" ? trim($row_select['nama_jabatan']) : ""; ?>" >
        </div>
    </div>
    <?php 
endif;
