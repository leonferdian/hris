...
<script>
    ...
    function view_report() {
        ...
        $.ajax({
            type: "GET",
            url: "inc/master/master_lc/view_report.php",
            traditional: true,
            // data: },
    ...
    function add_dialog() {
        ...
        $.ajax({
            type: "POST",
            url: "inc/master/master_lc/add_edit_delete.php",
            traditional: true,
            data:{
                act: 'add_dialog'
            },
    ...
    function add_lc() {
        ...
        var nama_lc = $("#modal_add_master #nama_lc").val();
        if (kode == "" || nama_lc == "") {
    ...
    function edit_lc() {
        ...
        var nama_lc = $("#modal_edit_master #nama_lc").val();
        if (kode == "" || nama_lc == "") {
            alert("Semua data harus diisi");
        } else {
            $.ajax({
