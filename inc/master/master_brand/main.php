<div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Master Brand</li>
        </ul>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h2 class="modal-title font-weight-bold">Add Brand</h2>
            </div>
...
<div class="modal fade" id="modal_edit_master" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h2 class="modal-title font-weight-bold">Edit Brand</h2>
            </div>
            <div class="modal-body">
            </div>
            <div class="modal-footer">
...
<script>
    ...
    function view_report() {
        ...
        $.ajax({
            type: "GET",
            url: "inc/master/master_brand/view_report.php",
            traditional: true,
            // data: },
    ...
    function add_dialog() {
        ...
        $.ajax({
            type: "POST",
            url: "inc/master/master_brand/add_edit_delete.php",
            traditional: true,
            data:{
                act: 'add_dialog'
            },
    ...
    function add_jabatan() {
        ...
        var nama_brand = $("#modal_add_master #nama_brand").val();
        if (kode == "" || nama_brand == "") {
    ...
    function edit_jabatan() {
        ...
        var nama_brand = $("#modal_edit_master #nama_brand").val();
        if (kode == "" || nama_brand == "") {
            alert("Semua data harus diisi");
        } else {
            $.ajax({
