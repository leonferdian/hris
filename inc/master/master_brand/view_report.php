...
<script>
    $(document).ready(function(){
        var table = $('#data_master_brand').DataTable({
            // order: [[ 0, "asc" ]],
            "paging": true,
            "bSort": true,
            "lengthChange": true,
...
<table width="100%" class="table table-striped table-bordered table-hover" id="data_master_brand">
    <thead>
        <tr>
            ...
            <th style="vertical-align:middle; text-align:center;">Nama Brand</th>
            <th style="vertical-align:middle; text-align:center; width:100px;">Act</th>
        </tr>
    </thead>
    <tbody>
        <?php
        $sql = "select * from [db_hris].[dbo].[table_master_brand]";
        $no = 1;
