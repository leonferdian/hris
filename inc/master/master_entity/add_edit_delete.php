...
if(isset($_POST['act']) && $_POST['act']=="add_data"):
    $sql_add = "INSERT INTO [db_hris].[dbo].[table_master_entity] 
    (
        [kode]
        ,[nama_entity]
        ,[create_by]
    ...
    (
        ...
        ,'".validate_input($_POST['nama_entity'])."'
        ,'".$_SESSION['nama']."'
        ,getdate()
        ,'".$_SESSION['nama']."'
        ,getdate()
...
elseif (isset($_POST['act']) && $_POST['act']=="edit_data"):
    $sql_update = "UPDATE [db_hris].[dbo].[table_master_entity] SET 
    kode = '".validate_input($_POST['kode'])."'
    ,nama_entity = '".validate_input($_POST['nama_entity'])."'
...
elseif(isset($_POST['act']) && $_POST['act']=="del"):
    $sql_del = "DELETE FROM [db_hris].[dbo].[table_master_entity] WHERE id = '".validate_input($_POST['id'])."'";
...
elseif(isset($_POST['act']) && ($_POST['act']=="add_dialog" || $_POST['act']=="edit_dialog")):
    if($_POST['act']=="edit_dialog"):
        $sql_select = "select * from [db_hris].[dbo].[table_master_entity] where id = '".$_POST['id']."'";
    ...
    <div class="row" style="width:100%;height:100%; margin-left: 5px;">
        ...
        <label class="col-sm-12 control-label">Nama Entity</label> 
        <div class="col-sm-10">
            <input type="text" class="form-control input-sm" id="nama_entity" name = "nama_entity" value="<?php echo $_POST['act'] == "edit_dialog" ? trim($row_select['nama_entity']) : ""; ?>" >
        </div>
    </div>
    <?php 
endif;
