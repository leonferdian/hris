...
<script>
    $(document).ready(function(){
        var table = $('#data_master_seksi').DataTable({
            // order: [[ 0, "asc" ]],
            "paging": true,
            "bSort": true,
            "lengthChange": true,
...
<table width="100%" class="table table-striped table-bordered table-hover" id="data_master_seksi">
    <thead>
        <tr>
            ...
            <th style="vertical-align:middle; text-align:center;">Nama Seksi</th>
            <th style="vertical-align:middle; text-align:center; width:100px;">Act</th>
        </tr>
    </thead>
    <tbody>
        <?php
        $sql = "select * from [db_hris].[dbo].[table_master_seksi]";
        $no = 1;
