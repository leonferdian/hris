<div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Master Seksi</li>
        </ul>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h2 class="modal-title font-weight-bold">Add Seksi</h2>
            </div>
            <div class="modal-body">
            </div>
            <div class="modal-footer">
                <button class="btn btn-sm btn-primary" onclick="add_seksi()">
...
<div class="modal fade" id="modal_edit_master" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h2 class="modal-title font-weight-bold">Edit Seksi</h2>
            </div>
            <div class="modal-body">
            </div>
            <div class="modal-footer">
                <button class="btn btn-sm btn-primary" onclick="edit_seksi()">
                    <i class="ace-icon fa fa-check"></i>
                    Save
                </button>
                <button class="btn btn-sm" data-dismiss="modal">
...
<script>
    ...
    function view_report() {
        ...
        $.ajax({
            type: "GET",
            url: "inc/master/master_seksi/view_report.php",
            traditional: true,
            // data: },
    ...
    function add_dialog() {
        ...
        $.ajax({
            type: "POST",
            url: "inc/master/master_seksi/add_edit_delete.php",
            traditional: true,
            data:{
                act: 'add_dialog'
            },
    ...
    function add_seksi() {
        ...
        var nama_seksi = $("#modal_add_master #nama_seksi").val();
        if (kode == "" || nama_seksi == "") {
    ...
    function edit_seksi() {
        ...
        var nama_seksi = $("#modal_edit_master #nama_seksi").val();
        if (kode == "" || nama_seksi == "") {
            alert("Semua data harus diisi");
        } else {
            $.ajax({
