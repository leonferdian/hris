    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h2 class="modal-title font-weight-bold">Add Divisi</h2>
            </div>
...
<div class="modal fade" id="modal_edit_master" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h2 class="modal-title font-weight-bold">Edit Divisi</h2>
            </div>
            <div class="modal-body">
            </div>
            <div class="modal-footer">
...
<script>
    ...
    function view_report() {
        ...
        $.ajax({
            type: "GET",
            url: "inc/master/master_divisi/view_report.php",
            traditional: true,
            // data: },
    ...
    function add_dialog() {
        ...
        $.ajax({
            type: "POST",
            url: "inc/master/master_divisi/add_edit_delete.php",
            traditional: true,
            data:{
                act: 'add_dialog'
            },
    ...
    function add_divisi() {
        ...
        var nama_divisi = $("#modal_add_master #nama_divisi").val();
        if (kode == "" || nama_divisi == "") {
    ...
    function edit_divisi() {
        ...
        var nama_divisi = $("#modal_edit_master #nama_divisi").val();
        if (kode == "" || nama_divisi == "") {
            alert("Semua data harus diisi");
        } else {
            $.ajax({
