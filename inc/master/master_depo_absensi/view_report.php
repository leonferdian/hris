...
<table width="100%" class="table table-striped table-bordered table-hover" id="data_master">
    <thead>
        <tr>
            ...
            <th style="vertical-align:middle; text-align:center;">Kode Depo</th>
            <th style="vertical-align:middle; text-align:center; width:100px;">Act</th>
        </tr>
    </thead>
    <tbody>
        <?php
        $sql = "SELECT [id], [username], [kode_depo] FROM [db_hris].[dbo].[table_depo_absensi] order by [username]";
        $no = 1;
