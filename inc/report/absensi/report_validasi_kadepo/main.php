<?php
if(isset($_GET['act'])):
    include 'inc/report/absensi/report_validasi_kadepo/'.$_GET['act'].'.php';
else:
...
<div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Report Validasi Absensi Kepala Depo</li>
        </ul>
    </div>
    <div class="page-content">
        <div class="page-header">
            <h1>
                Report Validasi Absensi Kepala Depo
            </h1>
...
<script>
    ...
    function view() {
        ...
        $.ajax({
            type: "GET",
            url: "inc/report/absensi/report_validasi_kadepo/view_report.php",
            traditional: true,
            data: {
                year: slc_tahun,
                month: slc_bulan
