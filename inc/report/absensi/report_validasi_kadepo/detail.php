...
<div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Detail Report Validasi Absensi Kepala Depo</li>
        </ul>
    </div>
    <div class="page-content">
        <div class="page-header">
            <h1 style="text-align: left;font-weight: bold; color:#646464">
                Detail Report Validasi Absensi Kepala Depo
            </h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
                                                ...
                                                <tbody id="body_table_strata_segment">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="center"><?php echo $row_mesin['depo']; ?></td>
                                                            ...
                                                            <td class="center"><?php echo $row_mesin['date_absen']; ?></td>
