...
<div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">List Task Validasi Absensi HRD</li>
        </ul>
    </div>
    <div class="page-content">
        <div class="page-header">
            <h1 style="text-align: left;font-weight: bold; color:#646464">
                List Task Validasi Absensi HRD
            </h1>
        </div>
        <div class="row">
            <div class="col-xs-12">
                                        ...
                                        <div class="table-responsive" id="list_core">
                                            <table class="table table-bordered table-hover datatable" id="table_absensi_report">
                                                ...
                                                <tbody id="body_table_strata_segment">
                                                    ...
                                                    ORDER BY absensi.depo, val.date_absen, absensi.nama";
                                                    // echo $sql_mesin;
                                                    $no = 1;
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="center"><?php echo date_format($row_validasi['date_absen'],"Y-m-d"); ?></td>
