...
$get_ras = mysqli_query($dbpdc,"SELECT DISTINCT `to`,`from`,`subject`,`date`,u.nama FROM tbl_requirement as r inner join user as u on r.from = u.id_user  WHERE read_req = 0 and `to` not like '%,%'");
$to = '';
//$to2 = '';
$no=1;
